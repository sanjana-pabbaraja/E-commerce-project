                    ...
                    <div class="box">
                        <form method="post" action="checkout4.jsp">
                            ...
                            <ul class="nav nav-pills nav-justified">
                                ...
                                <li><a href="checkout3.jsp"><i class="fa fa-money"></i><br>Payment Method</a>
                                </li>
                            ...
                            <div class="box-footer">
                                <div class="pull-left">
                                    <a href="checkout3.jsp" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back to Payment method</a>
                                </div>
