                    ...
                    <div class="box">
                        ...
                        <form>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="dname" value="Harry">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="mobileno" value="9876543210">
                            </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="email" value="harry123@gmail.com">
                            </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="password" value="1234567890" style="display:inline-block;width:93%;">
