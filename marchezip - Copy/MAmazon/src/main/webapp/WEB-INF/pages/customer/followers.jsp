...
<jsp:include page="../header.jsp" />
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9" id="customer-orders">
                    <div class="box">
                        <h2>My Followers (${followerslist.size()})</h2>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover dataTable" id="dataTables">
                                ...
                                <c:forEach items="${followerslist}" var="followerInfo">
                                    <tr>
                                        <th>${followerInfo.uname}</th>
                                        <td> ${followerInfo.mobileno}</td>
                                        <td>${followerInfo.email}</td>
                                        <td><a href="${pageContext.request.contextPath}/seller?id=${followerInfo.id}" class="btn btn-primary btn-sm">View</a>
                                    </tr>
                                 </c:forEach>
                                   <!--<tr>
                                        <th>Jhon</th>
