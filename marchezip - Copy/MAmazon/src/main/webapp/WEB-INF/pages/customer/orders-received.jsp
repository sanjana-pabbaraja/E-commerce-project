                            ...
                            <table class="table table-hover dataTable" id="dataTables">
                                ...
                                <c:forEach items="${paginationResult}" var="orderInfo">
                                    <tr>
                                        ...
                                        <td><a href="${pageContext.request.contextPath}/customer/receivedorder?orderId=${orderInfo.id}" class="btn btn-primary btn-sm">View</a>
                                        </td>
                                    </tr>
                                 </c:forEach>
                                   <!-- <tr>
                                        ...
                                        <td><a href="${pageContext.request.contextPath}/order" class="btn btn-primary btn-sm">View</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th># 1735</th>
